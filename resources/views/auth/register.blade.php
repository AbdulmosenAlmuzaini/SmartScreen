...
<head>
    ...
    <title>{{ __('Register') }} - SmartScreen</title>
...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="glass-panel p-8 rounded-3xl shadow-2xl">
            <h2 class="text-xl font-semibold mb-2">{{ __('Create Account') }}</h2>
            <p class="text-xs text-gray-400 mb-6">{{ __('Register a new account to manage digital signage displays.') }}</p>
            ...
            <div class="mt-6 text-center text-xs text-gray-400">
                ...
                <a href="{{ route('login') }}" class="text-purple-400 hover:text-purple-300 font-medium underline underline-offset-4 ml-1">{{ __('Log In') }}</a>
            </div>
        </div>
